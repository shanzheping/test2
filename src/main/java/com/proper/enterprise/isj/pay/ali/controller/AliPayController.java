...
public class AliPayController extends BaseController {
    ...
    private static String verifyResponse(String notifyId) {
        ...
        String veryfy_url = AliConstants.ALI_PAY_NOTICE_HTTPS_VERIFY_URL + "partner=" + partner + "&notify_id=" + notifyId;
     ...
     * @return 布尔值
     */
    public static boolean rsaVerify(String content, String sign, String aliPublicKey, String inputCharset)
    {
        try
        {
    ...
    public static boolean stringIsEmpty(String checkValue) {
        if(checkValue == null || "".equals(checkValue) || checkValue.length() == 0) {
            return true;
        } else {
            return false;
        }
